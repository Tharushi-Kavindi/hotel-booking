...
export default function Hero() {
  ...
  return (
    <div className="relative h-[500px] md:h-[600px] py-3 mx-4 overflow-hidden rounded-3xl bg- z-0">
      {/* Background Images */}
      ...
      {/* Hero Content */}
      <div className="relative z-10 flex flex-col items-center text-white justify-center h-full px-4 sm:px-8 sm:z-0">
        <h1 className="text-4xl md:text-6xl font-bold mb-4 text-center">
          Find Your Best Staycation
        </h1>
        <p className="text-base md:text-lg mb-8 text-center max-w-2xl">
          Share your dream destination and experience, and we'll find the
        ...
        <form onSubmit={handleSearch} className="w-full max-w-xl">
          <div className="relative flex items-center">
            ...
            <button
              type="submit"
              className="absolute right-2 h-[60%] my-auto bg-black text-white rounded-full px-2 sm:px-4 flex items-center gap-x-2 border-white border-2 hover:bg-white/10 transition-colors"
            >
